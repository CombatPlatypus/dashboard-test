...
function restorePlanningState(
    ...
    planningState.dailyCapacity =
        Object.prototype.hasOwnProperty.call(
            ...
            ? normalizeQuantity(
                sessionState.dailyCapacity,
            )
            : DEFAULT_PLANNING_DAILY_CAPACITY;

    const vehicleCounts =
        sessionState.vehicleCounts &&
        typeof sessionState.vehicleCounts ===
            "object"
            ? sessionState.vehicleCounts
            : {};
    ...
    const collectionPool =
        sessionState.collectionPool &&
        typeof sessionState.collectionPool ===
            "object"
            ? sessionState.collectionPool
            : {};
    ...
    notifyPlanningState({
        type: "planning-session-imported",
    });
